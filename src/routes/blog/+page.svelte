...
--antd-lime-10:#254000;
--antd-lime10:#254000;
--antd-colorText:rgba(34, 34, 34, 0.88);
--antd-colorTextSecondary:rgba(34, 34, 34, 0.65);
--antd-colorTextTertiary:rgba(34, 34, 34, 0.45);
--antd-colorTextQuaternary:rgba(34, 34, 34, 0.25);
--antd-colorFill:rgba(34, 34, 34, 0.15);
--antd-colorFillSecondary:rgba(34, 34, 34, 0.06);
--antd-colorFillTertiary:rgba(34, 34, 34, 0.04);
--antd-colorFillQuaternary:rgba(34, 34, 34, 0.02);
--antd-colorBgLayout:#f5f5f5;
--antd-colorBgContainer:#ffffff;
--antd-colorBgElevated:#ffffff;
--antd-colorBgSpotlight:rgba(34, 34, 34, 0.85);
...
--antd-colorFillContent:rgba(34, 34, 34, 0.06);
--antd-colorFillContentHover:rgba(34, 34, 34, 0.15);
--antd-colorFillAlter:rgba(34, 34, 34, 0.02);
--antd-colorBgContainerDisabled:rgba(34, 34, 34, 0.04);
--antd-colorBorderBg:#ffffff;
--antd-colorSplit:rgba(5, 5, 5, 0.06);
--antd-colorTextPlaceholder:rgba(34, 34, 34, 0.25);
--antd-colorTextDisabled:rgba(34, 34, 34, 0.25);
--antd-colorTextHeading:rgba(34, 34, 34, 0.88);
--antd-colorTextLabel:rgba(34, 34, 34, 0.65);
--antd-colorTextDescription:rgba(34, 34, 34, 0.45);
--antd-colorTextLightSolid:#fff;
--antd-colorHighlight:#ff4d4f;
--antd-colorBgTextHover:rgba(34, 34, 34, 0.06);
--antd-colorBgTextActive:rgba(34, 34, 34, 0.15);
--antd-colorIcon:rgba(34, 34, 34, 0.45);
--antd-colorIconHover:rgba(34, 34, 34, 0.88);
...
--antd-controlItemBgHover:rgba(34, 34, 34, 0.04);
--antd-controlItemBgActive:#e6f4ff;
--antd-controlItemBgActiveHover:#bae0ff;
--antd-controlItemBgActiveDisabled:rgba(34, 34, 34, 0.15);
--antd-controlTmpOutline:rgba(34, 34, 34, 0.02);
...
--antd-_tokenKey:1f7c6b2;
--antd-_hashId:css-dev-only-do-not-override-121ruu3;
}
  </style>
